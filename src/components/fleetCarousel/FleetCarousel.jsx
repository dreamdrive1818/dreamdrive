                    ...
                    >
                      ...
                      <div className={`car-hover-info ${hoveredIndex === absoluteIndex ? "car-hover-info-show" : ""}`}>
                        ...
                        <div className="hover-bottom">
                          <div><FontAwesomeIcon icon={faCarSide} /><p>{car.details?.type}</p></div>
                          <div><FontAwesomeIcon icon={faUserFriends} /><p>{car.details?.seats}</p></div>
                          <div><FontAwesomeIcon icon={faSuitcaseRolling} /><p>{car.details?.luggage}</p></div>
                          <div><FontAwesomeIcon icon={faGasPump} /><p>{car.details?.fuel}</p></div>
                          <div><FontAwesomeIcon icon={faCogs} /><p>{car.details?.mt}</p></div>
                        </div>
                      </div>
                    </div>
                  );
